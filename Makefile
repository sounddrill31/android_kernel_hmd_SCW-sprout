...
#merged by changxue.fang for thething,20210315
# Add HS-hmd module include path
LINUXINCLUDE    += -I$(srctree)/drivers/soc/hs/include
...
KBUILD_CPPFLAGS += -DTARGET_PRODUCT_PUNISHER=1
endif
