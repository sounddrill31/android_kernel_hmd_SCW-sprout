...
// add for dispaly on ramdump screen begin(2020-04-17)	
#ifdef CONFIG_SUPPORT_CRASH_REASON
extern void dump_kernel_fault(const char *desc, unsigned long addr);
#endif // CONFIG_SUPPORT_CRASH_REASON		
// add for dispaly on ramdump screen end
