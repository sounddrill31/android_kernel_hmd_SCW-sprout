...
int show_unhandled_signals = 0;
 ...
 ///*Ramdump UI Display porting by zhongli.liu at 20201119 start*/	
#ifdef CONFIG_SUPPORT_CRASH_REASON
extern void dump_kernel_die(const char *desc, int err, struct pt_regs *regs);
#endif // CONFIG_SUPPORT_CRASH_REASON		
 ///*Ramdump UI Display porting by zhongli.liu at 20201119 end*/	
