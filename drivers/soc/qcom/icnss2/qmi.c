...
#if IS_ENABLED(CONFIG_HS_PRODUCT_DEVINFO)
#include <linux/productinfo.h>
extern char wlan_version[];

/* WCN39XX chip family */
#define WCN_3950       0x4007
#define WCN_3980       0x4002
#define WCN_3991       0x4001

#define WCN_UMC        0x4320
#define WCN_TSMC       0x320
...
int wlfw_cap_send_sync_msg(struct icnss_priv *priv)
{
	...
	#if IS_ENABLED(CONFIG_HS_PRODUCT_DEVINFO)
	/* identify chip id */
	switch (priv->chip_info.chip_family) {
	case WCN_3991:
		switch (priv->chip_info.chip_id) {
		case WCN_UMC:
			strlcpy(wlan_version, "WCN3991_UMC", sizeof("WCN3991_UMC"));
			break;
		case WCN_TSMC:
			strlcpy(wlan_version, "WCN3991_TSMC", sizeof("WCN3991_TSMC"));
			break;
		default:
			strlcpy(wlan_version, "WCN3991", sizeof("WCN3991"));
			break;
		}
		break;
	case WCN_3980:
		strlcpy(wlan_version, "WCN3980", sizeof("WCN3980"));
		break;
	case WCN_3950:
		strlcpy(wlan_version, "WCN3950", sizeof("WCN3950"));
		break;
	default:
		strlcpy(wlan_version, "WCN39XX", sizeof("WCN39XX"));
		break;
	}
