...
int himax_hx83113_start(struct himax_chip_entry *entry)
{
	
	entry->hx_ic_dt_num = 1;
	entry->core_chip_dt = kcalloc(1,
				sizeof(struct himax_chip_detect), GFP_KERNEL);
	entry->core_chip_dt[0].fp_chip_detect = hx83113_chip_detect;
