...
//#define CONFIG_TOUCHSCREEN_FT_SPI_FH 1
//#define CONFIG_TOUCHSCREEN_FT_SPI_GESTURE 1
//#define CONFIG_TOUCHSCREEN_FT_SPI_GLOVE 1
/*****************************************************************************
...
struct fts_ts_platform_data {
	...
	bool keep_lcd_suspend_reset_high;
#endif
};
...
extern int factory_get_module_id(struct device *dev, char *buf);
