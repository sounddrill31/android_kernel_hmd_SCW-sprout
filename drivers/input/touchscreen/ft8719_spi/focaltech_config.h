 ...
 */
#define FT8719_FTS_CHIP_TYPE   _FT8719
 ...
 */
#define FT8719_FTS_DEBUG_EN                            1

/*
 * Linux MultiTouch Protocol
 * 1: Protocol B(default), 0: Protocol A
 */
#define FT8719_FTS_MT_PROTOCOL_B_EN                    1

/*
 * Report Pressure in multitouch
 * 1:enable(default),0:disable
*/
#define FT8719_FTS_REPORT_PRESSURE_EN                  1
 ...
 * default: disable
 */
#define FT8719_FTS_ESDCHECK_EN                         0
 ...
 * default: disable
 */
#define FT8719_FTS_PINCTRL_EN                          0
 ...
 * auto upgrade
 */
#define FT8719_FTS_AUTO_UPGRADE_EN                     1
 ...
 * If means vendor_id, the FT8719_FTS_MODULE_ID = PANEL_ID << 8 + VENDOR_ID
 * FTS_GET_MODULE_NUM == 0/1, no check module id, you may ignore them
 * FTS_GET_MODULE_NUM >= 2, compatible with FT8719_FTS_MODULE2_ID
 * FTS_GET_MODULE_NUM >= 3, compatible with FT8719_FTS_MODULE3_ID
 */
#define FT8719_FTS_MODULE_ID                          0x0000
#define FT8719_FTS_MODULE2_ID                         0x0000
#define FT8719_FTS_MODULE3_ID                         0x0000

/*
 * Need set the following when get firmware via firmware_request()
 * For example: if module'vendor is tianma,
 * #define FT8719_FTS_MODULE_NAME                        "tianma"
 * then file_name will be "focaltech_ts_fw_tianma"
 * You should rename fw to "focaltech_ts_fw_tianma", and push it into
 * etc/firmware or by customers
 */
#define FT8719_FTS_MODULE_NAME                        ""
#define FT8719_FTS_MODULE2_NAME                       ""
#define FT8719_FTS_MODULE3_NAME                       ""

/*
 * FW.i file for auto upgrade, you must replace it with your own
 * define your own ft8719_fw_file, the sample one to be replaced is invalid
 * NOTE: if FTS_GET_MODULE_NUM > 1, it's the fw corresponding with FTS_VENDOR_ID
 */
#define FT8719_FTS_UPGRADE_FW_FILE                      "include/firmware/fw_sample.i"

/*
 * if FTS_GET_MODULE_NUM >= 2, fw corrsponding with FTS_VENDOR_ID2
 * define your own ft8719_fw_file, the sample one is invalid
 */
#define FT8719_FTS_UPGRADE_FW2_FILE                     "include/firmware/fw_sample.i"

/*
 * if FTS_GET_MODULE_NUM >= 3, fw corrsponding with FTS_VENDOR_ID3
 * define your own ft8719_fw_file, the sample one is invalid
 */
#define FT8719_FTS_UPGRADE_FW3_FILE                     "include/firmware/fw_sample.i"
