...
// Add-begin by ning.wei for print power key press log
#include <linux/rtc.h>
// Add-end by ning.wei for print power key press log
...
static int qpnp_pon_input_dispatch(struct qpnp_pon *pon, u32 pon_type)
{
	...
	if (cfg->pon_type == PON_KPDPWR) {
	    ...
	    printk(KERN_ERR"[%02d:%02d:%02d]Report pwrkey %s event,key_code:%d\n", tm.tm_hour, tm.tm_min, tm.tm_sec,
