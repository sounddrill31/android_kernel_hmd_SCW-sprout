...
/*
 * Voltage to temperature table for 30k pull up for bat_therm with
 * 10K NTC(NCP_XH103 10k 3380K).
 */
static const struct vadc_map_pt adcmap_batt_therm_30k_NCP_XH103[] = {
	{1663,	-400},
	{1639,	-380},
	{1613,	-360},
	{1585,	-340},
				...
				u16 adc_code, int *result_mdec)
{
	...
	/* Map voltage to temperature from look-up table */
#ifdef CONFIG_HS_BATTERY_THERM_NTC_10K
	return qcom_vadc_map_voltage_temp(adcmap_batt_therm_30k_NCP_XH103,
				 ARRAY_SIZE(adcmap_batt_therm_30k_NCP_XH103),
				 voltage, result_mdec);
#else /*CONFIG_HS_BATTERY_THERM_NTC_10K*/
