...
//merged by changxue.fang for thething,20210414,start
       ...
       case POWER_SUPPLY_PROP_CHARGER_TYPE:
		...
		if (value.intval == QTI_POWER_SUPPLY_TYPE_USB_HVDCP)
			value.intval = POWER_SUPPLY_TYPE_USB_HVDCP;
		else if (value.intval == QTI_POWER_SUPPLY_TYPE_USB_HVDCP_3)
			value.intval = POWER_SUPPLY_TYPE_USB_HVDCP_3;
		else if (value.intval == QTI_POWER_SUPPLY_TYPE_USB_HVDCP_3P5)
			value.intval = POWER_SUPPLY_TYPE_USB_HVDCP_3P5;
		else if (value.intval == QTI_POWER_SUPPLY_TYPE_USB_FLOAT)
			value.intval = POWER_SUPPLY_TYPE_USB_FLOAT;
